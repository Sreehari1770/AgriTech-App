...
import { Provider } from 'react-redux'; // Importing Provider to provide Redux store
import store from './assets/others/store'; // Importing Redux store
    ...
    <Provider store={store}> {/* Provide the Redux store to the entire application */}
      <Router>
        <Routes>
          ...
          <Route path="/admin/addloan" element={<AddLoanPage/>} />
        </Routes>
      </Router>
    </Provider>
  );
